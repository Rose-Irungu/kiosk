export default function AlertCard({time}) {
  return (
    
  <div className="bg-[#005e0e] rounded-[12px] w-[calc(100vw-2rem)] sm:w-auto sm:max-w-[964px] md:w-[964px] p-5 flex flex-col items-center justify-center gap-1">
      <img
