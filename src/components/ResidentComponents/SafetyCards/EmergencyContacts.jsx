  ...
  return (
    <div className='flex flex-col w-full h-[108px] border-b-[1px] py-[12px] px-[10px] gap-[12px]'>
        ...
        <div className='flex flex-row w-[365px] h-[40px] gap-[8px]'>
            <div className='flex flex-row w-[181px] h-[40px] rounded-[8px] border-[1px] border-[#005E0E] p-[4px] gap-[4px]'>
            ...
            <div className='flex flex-row text-center align-items-center justify-center w-[181px] h-[40px] rounded-[8px] border-[1px] border-[#005E0E] p-[4px] gap-[4px]'>
                <img src={icon2} className='w-[24px] h-[24px] object-contain' />
