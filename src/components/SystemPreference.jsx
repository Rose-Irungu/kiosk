            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between ">
                ...
                <button
                  ...
                  className={`relative inline-flex h-4 w-8 items-center ml-x rounded-full transition-colors focus:outline-none   focus:ring-offset-2 ${maintenanceMode ? 'bg-[#005e0e]' : 'bg-gray-300'
                    }`}
                >
                  <span
                    className={`inline-block h-3 w-3 transform rounded-full bg-white transition-transform ${maintenanceMode ? 'translate-x-4' : 'translate-x-1'
                      }`}
                  />
                </button>
              </div>
