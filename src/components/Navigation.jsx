  ...
  const navItems = [
    {
      id: "dashboard",
      label: "Dashboard",
      icon: "/material-symbols-dashboard-rounded0.svg",
    },
    { id: "users", label: "Users", icon: "/mdi-users0.svg" },
    {
      id: "visitors",
      label: "Visitors",
      icon: "/material-symbols-nest-doorbell-visitor0.svg",
    },
    {
      id: "emergencies",
      label: "Emergencies",
      icon: "/material-symbols-e-911-emergency-rounded0.svg",
    },
    {
      id: "incidents",
      label: "Incident Reports",
      icon: "/tabler-message-report-filled0.svg",
    },
  ];
          ...
          {navItems.map((item) => (
            ...
            >
              <img
                ...
                alt=""
                className={`h-5 w-5 ${
                  active === item.id ? "filter brightness-0" : ""
                }`}
              />
