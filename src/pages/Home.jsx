...
const HomePage = () => {
  return (
    <div className="flex flex-col min-h-screen w-screen overflow-x-hidden relative">
      ...
      {/* Check In Button */}
      <button
        className="  flex flex-col items-center w-full sm:w-auto p-4 rounded-md shadow-md bg-gradient-to-r from-green-500 via-green-500 to-green-600"
      >
        <img src={ download } alt="Enter icon" className="w-6 h-7 mb-5" />
        <span className="text-white text-lg font-medium">Check in guest</span>
      </button>

      {/* Check Out Button */}
      <button
        className=" flex flex-col items-center w-full sm:w-auto p-4 rounded-md shadow-md bg-gradient-to-r from-blue-800 to-blue-600"
      >
        <img
            src={out}
            alt="Exit icon"
        ...
        />
        <span className="text-white text-lg font-medium">Check out guest</span>
      </button>
    </div>
